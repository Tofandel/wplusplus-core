...
if ( file_exists( dirname( __FILE__ ) . '/info-html.html' ) ) {
	...
	$sample_html = $wp_filesystem->get_contents( dirname( __FILE__ ) . '/info-html.html' );
}
...
$args = array(
	...
	// This MUST be changed and must be unique to YOUR project.
	'opt_name'                  => $opt_name,
...
Redux::setHelpTab( $opt_name, $help_tabs );
	...
	array(
		...
		'fields'     => array(
			array(
				...
				'mode'     => 'css',
				'theme'    => 'monokai',
				'desc'     => 'Possible modes can be found at <a href="//ace.c9.io" target="_blank">http://ace.c9.io/</a>.',
				'default'  => '#header{
	margin: 0 auto;
}',
			),
	...
	array(
		...
		'fields'     => array(
			...
			array(
				...
				'data'     => 'capabilities',
				'multi'    => true,
				'title'    => esc_html__( 'Capabilities Select Option', 'your-domain-here' ),
				'subtitle' => esc_html__( 'No validation can be done on this field type', 'your-domain-here' ),
				'desc'     => esc_html__( 'This is the description field, again good for additional info.', 'your-domain-here' ),
			),
			array(
	...
	array(
		...
		'fields'     => array(
			...
			array(
				...
				'subtitle'          => esc_html__( 'You decide.', 'your-domain-here' ),
				'desc'              => esc_html__( 'Enter <code>1</code> and click <strong>Save Changes</strong> for an error message, or enter <code>2</code> and click <strong>Save Changes</strong> for a warning message.', 'your-domain-here' ),
