...
Redux::setSection( $opt_name, array(
	'title'  => __( 'Basic Field', 'your-domain-here' ),
	'id'     => 'basic',
	'desc'   => __( 'Basic field with no subsections.', 'your-domain-here' ),
	'icon'   => 'el el-home',
	'fields' => array(
		array(
			'id'       => 'opt-text',
			'type'     => 'text',
			'title'    => __( 'Example Text', 'your-domain-here' ),
			'desc'     => __( 'Example description.', 'your-domain-here' ),
			'subtitle' => __( 'Example subtitle.', 'your-domain-here' ),
			'hint'     => array(
...
Redux::setSection( $opt_name, array(
	'title'      => __( 'Text Area', 'your-domain-here' ),
	...
	'fields'     => array(
		array(
			'id'       => 'textarea-example',
			'type'     => 'textarea',
			'title'    => __( 'Text Area Field', 'your-domain-here' ),
			'subtitle' => __( 'Subtitle', 'your-domain-here' ),
			'desc'     => __( 'Field Description', 'your-domain-here' ),
			'default'  => 'Default Text',
		),
