	...
	<div data-opt-name="<?php echo esc_attr( $this->parent->args['opt_name'] ); ?>"
		...
		<form method="post"
			...
			<input type="hidden" id="redux-compiler-hook"
				   name="<?php echo esc_attr( $this->parent->args['opt_name'] ); ?>[compiler]" value=""/>
			<input type="hidden" id="currentSection"
				   name="<?php echo esc_attr( $this->parent->args['opt_name'] ); ?>[redux-section]" value=""/>
