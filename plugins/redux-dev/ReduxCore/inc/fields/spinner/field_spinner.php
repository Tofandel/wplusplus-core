...
if (!class_exists('ReduxFramework_spinner', false)) {
    ...
    class ReduxFramework_spinner extends Redux_Field {
        ...
        function enqueue() {
            wp_enqueue_script(
                    'redux-field-spinner-custom-js', ReduxCore::$_url . 'inc/fields/spinner/vendor/spinner_custom.js', array('jquery', 'redux-js'), $this->timestamp, true
            );

            wp_enqueue_script(
                    'redux-field-spinner-js', ReduxCore::$_url . 'inc/fields/spinner/field_spinner' . Redux_Functions::isMin() . '.js', array(
                'jquery',
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                        'redux-field-spinner-css', ReduxCore::$_url . 'inc/fields/spinner/field_spinner.css', array(), $this->timestamp, 'all'
                );
            }
        }
