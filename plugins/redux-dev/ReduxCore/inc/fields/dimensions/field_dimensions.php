...
if (!class_exists('ReduxFramework_dimensions', false)) {
    ...
    class ReduxFramework_dimensions extends Redux_Field {
        ...
        function enqueue() {
            ...
            wp_enqueue_script(
                    'redux-field-dimensions-js', ReduxCore::$_url . 'inc/fields/dimensions/field_dimensions' . Redux_Functions::isMin() . '.js', array('jquery', 'select2-js', 'redux-js'), $this->timestamp, true
            );

            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                        'redux-field-dimensions-css', ReduxCore::$_url . 'inc/fields/dimensions/field_dimensions.css', array(), $this->timestamp, 'all'
                );
            }
        }
