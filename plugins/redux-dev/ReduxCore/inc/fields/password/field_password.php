...
if (!class_exists('ReduxFramework_password', false)) {
    ...
    class ReduxFramework_password extends Redux_Field {
        ...
        private function _render_combined_field() {
            ...
            // Username field
            echo '<input type="text" autocomplete="off" placeholder="' . esc_attr($this->value['placeholder']['username']) . '" id="' . esc_attr($this->field['id']) . '[username]" name="' . esc_attr($this->field['name'] . $this->field['name_suffix']) . '[username]' . '" value="' . esc_attr($this->value['username']) . '" class="' . esc_attr($this->field['class']) . '" />&nbsp;';

            // Password field
            echo '<input type="password" autocomplete="off" placeholder="' . esc_attr($this->value['placeholder']['password']) . '" id="' . esc_attr($this->field['id']) . '[password]" name="' . esc_attr($this->field['name'] . $this->field['name_suffix']) . '[password]' . '" value="' . esc_attr($this->value['password']) . '" class="' . esc_attr($this->field['class']) . '" />';
        }
        ...
        private function _render_single_field() {
            echo '<input type="password" id="' . esc_attr($this->field['id']) . '" name="' . esc_attr($this->field['name'] . $this->field['name_suffix']) . '" value="' . esc_attr($this->value) . '" class="' . esc_attr($this->field['class']) . '" />';
        }
