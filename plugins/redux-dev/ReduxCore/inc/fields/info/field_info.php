...
// Don't duplicate me!
if (!class_exists('ReduxFramework_info', false)) {
     ...
     * @since       1.0.0
     */
    class ReduxFramework_info extends Redux_Field {
        ...
        public function enqueue() {
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                        'redux-field-info-css', ReduxCore::$_url . 'inc/fields/info/field_info.css', array(), $this->timestamp, 'all'
                );
            }
        }
