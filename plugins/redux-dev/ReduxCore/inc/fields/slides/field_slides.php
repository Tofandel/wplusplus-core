...
// Don't duplicate me!
if (!class_exists('ReduxFramework_slides', false)) {
    ...
    class ReduxFramework_slides extends Redux_Field {
        ...
        public function render() {
            ...
            if (isset($this->value) && is_array($this->value) && !empty($this->value)) {
                ...
                foreach ($slides as $slide) {
                    ...
                    echo '<img class="redux-slides-image" id="image_image_id_' . $x . '" src="' . esc_url($slide['thumb']) . '" alt="' . esc_attr($alt) . '" target="_blank" rel="external" />';
                    echo '</a>';
                    echo '</div>';
        ...
        public function enqueue() {
            ...
            if ($this->parent->args['dev_mode']) {
                ...
                wp_enqueue_style(
                        'redux-field-slides-css', ReduxCore::$_url . 'inc/fields/slides/field_slides.css', array(), $this->timestamp, 'all'
                );
            }

            wp_enqueue_script(
                    'redux-field-media-js', ReduxCore::$_url . 'assets/js/media/media' . Redux_Functions::isMin() . '.js', array('jquery', 'redux-js'), $this->timestamp, true
            );

            wp_enqueue_script(
                    'redux-field-slides-js', ReduxCore::$_url . 'inc/fields/slides/field_slides' . Redux_Functions::isMin() . '.js', array(
                'jquery',
                'jquery-ui-core',
                'jquery-ui-accordion',
                'jquery-ui-sortable',
