...
if (!class_exists('ReduxFramework_media', false)) {
    ...
    class ReduxFramework_media extends Redux_Field {
        ...
        public function render() {
            ...
            echo '<img class="redux-option-image" id="image_' . esc_attr($this->field['id']) . '" src="' . esc_url($this->value['thumbnail']) . '" alt="' . esc_attr($alt) . '" target="_blank" rel="external" style="' . $css . '" />';
            echo '</a>';
            echo '</div>';
