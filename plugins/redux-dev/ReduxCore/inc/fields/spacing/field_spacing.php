...
if (!class_exists('ReduxFramework_spacing', false)) {
    ...
    class ReduxFramework_spacing extends Redux_Field {
        ...
        function render() {
             ...
             * Units
             * */
            if ($this->field['units'] != false && /* is_array( $this->field['units'] ) && */
                    $this->field['display_units'] == true) {
        ...
        function enqueue() {
            ...
            wp_enqueue_script(
                    'redux-field-spacing-js', ReduxCore::$_url . 'inc/fields/spacing/field_spacing' . Redux_Functions::isMin() . '.js', array('jquery', 'select2-js', 'redux-js'), $this->timestamp, true
            );

            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                        'redux-field-spacing-css', ReduxCore::$_url . 'inc/fields/spacing/field_spacing.css', array(), $this->timestamp, 'all'
                );
            }
        }
