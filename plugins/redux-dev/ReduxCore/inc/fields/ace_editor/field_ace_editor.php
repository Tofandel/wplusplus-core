...
if (!class_exists('ReduxFramework_ace_editor', false)) {
    ...
    class ReduxFramework_ace_editor extends Redux_Field {
        ...
        function render() {
            ...
            <div class="ace-wrapper">
                ...
                <pre id="<?php echo esc_attr($this->field['id']); ?>-editor"
                     class="ace-editor-area"><?php echo htmlspecialchars($this->value); ?>
                </pre>
            </div>
            <?php
        }
        ...
        public function enqueue() {
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                        'redux-field-ace-editor-css', ReduxCore::$_url . 'inc/fields/ace_editor/field_ace_editor.css', array(), $this->timestamp, 'all'
                );
            }

            if (!wp_script_is('ace-editor-js')) {
                Redux_CDN::enqueue_script(
                        'ace-editor-js', '//' . 'cdn' . '.jsdelivr' . '.net/ace/1.2.6/min/ace.js', array('jquery'), '1.2.6', true
                );
            }

            wp_enqueue_script(
                    'redux-field-ace-editor-js', ReduxCore::$_url . 'inc/fields/ace_editor/field_ace_editor' . Redux_Functions::isMin() . '.js', array('jquery', 'ace-editor-js', 'redux-js'), $this->timestamp, true
            );
        }
