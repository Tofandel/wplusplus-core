...
if (!class_exists('ReduxFramework_button_set', false)) {
    ...
    class ReduxFramework_button_set extends Redux_Field {
        ...
        public function enqueue() {
            wp_enqueue_script(
                    'redux-field-button-set-js', ReduxCore::$_url . 'inc/fields/button_set/field_button_set' . Redux_Functions::isMin() . '.js', array('jquery', 'jquery-ui-core', 'redux-js'), $this->timestamp, true
            );
        }
