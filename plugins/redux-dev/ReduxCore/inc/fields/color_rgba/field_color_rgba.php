...
// Don't duplicate me!
if (!class_exists('ReduxFramework_color_rgba', false)) {
     ...
     * @since       1.0.0
     */
    class ReduxFramework_color_rgba extends Redux_Field {
        ...
        public function enqueue() {
            ...
            // Field dependent JS
            wp_enqueue_script(
                    'redux-field-color-rgba-js', ReduxCore::$_url . 'inc/fields/color_rgba/field_color_rgba' . Redux_Functions::isMin() . '.js', array('jquery', 'redux-spectrum-js', 'redux-js'), $this->timestamp, true
            );
            ...
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                        'redux-field-color-rgba-css', ReduxCore::$_url . 'inc/fields/color_rgba/field_color_rgba.css', array(), $this->timestamp, 'all'
                );
            }
        }
