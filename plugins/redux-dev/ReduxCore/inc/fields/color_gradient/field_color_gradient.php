...
if (!class_exists('ReduxFramework_color_gradient', false)) {
    ...
    class ReduxFramework_color_gradient extends Redux_Field {
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                    'redux-field-color-gradient-js', ReduxCore::$_url . 'inc/fields/color_gradient/field_color_gradient' . Redux_Functions::isMin() . '.js', array('jquery', 'wp-color-picker', 'redux-js'), $this->timestamp, true
            );
            ...
            if ($this->parent->args['dev_mode']) {
                ...
                wp_enqueue_style(
                        'redux-field-color_gradient-css', ReduxCore::$_url . 'inc/fields/color_gradient/field_color_gradient.css', array(), $this->timestamp, 'all'
                );
            }
        }
