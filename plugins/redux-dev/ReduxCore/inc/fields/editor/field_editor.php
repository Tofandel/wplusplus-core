    ...
    class ReduxFramework_editor extends Redux_Field {
        ...
        public function enqueue() {
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                        'redux-field-editor-css', ReduxCore::$_url . 'inc/fields/editor/field_editor.css', array(), $this->timestamp, 'all'
                );
            }

            wp_enqueue_script(
                    'redux-field-editor-js', ReduxCore::$_url . 'inc/fields/editor/field_editor' . Redux_Functions::isMin() . '.js', array('jquery', 'redux-js'), $this->timestamp, true
            );
        }
