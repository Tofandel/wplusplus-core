...
//function
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                    'redux-field-select-js', ReduxCore::$_url . 'inc/fields/select/field_select' . Redux_Functions::isMin() . '.js', array('jquery', 'select2-js', 'redux-js'), $this->timestamp, true
            );

            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                        'redux-field-select-css', ReduxCore::$_url . 'inc/fields/select/field_select.css', array(), $this->timestamp, 'all'
                );
            }
        }
        ...
        function ajax_callback() {
            ...
            $options = $this->parent->get_wordpress_data($_REQUEST['data']);
