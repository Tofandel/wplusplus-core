...
// Don't duplicate me!
if (!class_exists('ReduxFramework_border', false)) {
    ...
    class ReduxFramework_border extends Redux_Field {
        ...
        function enqueue() {
            ...
            wp_enqueue_script(
                    'redux-field-border-js', ReduxCore::$_url . 'inc/fields/border/field_border' . $min . '.js', $dep_array, $this->timestamp, true
            );
            ...
            if ($this->parent->args['dev_mode']) {
                ...
                wp_enqueue_style(
                        'redux-field-border-css', ReduxCore::$_url . 'inc/fields/border/field_border.css', array(), $this->timestamp, 'all'
                );
            }
        }
