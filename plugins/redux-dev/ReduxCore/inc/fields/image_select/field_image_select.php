...
// Don't duplicate me!
if (!class_exists('ReduxFramework_image_select', false)) {
    ...
    class ReduxFramework_image_select extends Redux_Field {
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                    'redux-field-image-select-js', ReduxCore::$_url . 'inc/fields/image_select/field_image_select' . Redux_Functions::isMin() . '.js', array('jquery', 'redux-js'), $this->timestamp, true
            );

            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                        'redux-field-image-select-css', ReduxCore::$_url . 'inc/fields/image_select/field_image_select.css', array(), $this->timestamp, 'all'
                );
            }
        }
