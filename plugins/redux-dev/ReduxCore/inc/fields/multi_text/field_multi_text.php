...
if (!class_exists('ReduxFramework_multi_text', false)) {
    ...
    class ReduxFramework_multi_text extends Redux_Field {
        ...
        public function enqueue() {
            wp_enqueue_script(
                    'redux-field-multi-text-js', ReduxCore::$_url . 'inc/fields/multi_text/field_multi_text' . Redux_Functions::isMin() . '.js', array('jquery', 'redux-js'), $this->timestamp, true
            );

            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                        'redux-field-multi-text-css', ReduxCore::$_url . 'inc/fields/multi_text/field_multi_text.css', array(), $this->timestamp, 'all'
                );
            }
        }
