...
if (!class_exists('ReduxFramework_sorter', false)) {

    class ReduxFramework_sorter extends Redux_Field {
        ...
        function enqueue() {
            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                        'redux-field-sorder-css', ReduxCore::$_url . 'inc/fields/sorter/field_sorter.css', array(), $this->timestamp, 'all'
                );
            }

            wp_enqueue_script(
                    'redux-field-sorter-js', ReduxCore::$_url . 'inc/fields/sorter/field_sorter' . Redux_Functions::isMin() . '.js', array('jquery', 'redux-js', 'jquery-ui-sortable'), $this->timestamp, true
            );
        }
