...
//function
        ...
        function enqueue() {
            ...
            wp_enqueue_script(
                    'field-select-image-js', ReduxCore::$_url . 'inc/fields/select_image/field_select_image' . Redux_Functions::isMin() . '.js', array('jquery', 'select2-js', 'redux-js'), $this->timestamp, true
            );

            if ($this->parent->args['dev_mode']) {
                wp_enqueue_style(
                        'redux-field-select-image-css', ReduxCore::$_url . 'inc/fields/select_image/field_select_image.css', array(), $this->timestamp, 'all'
                );
            }
        }
