    ...
    class Redux_Args {
        ...
        private function no_errors_please($args) {
            ...
            if (empty($args['footer_credit'])) {
                $args['footer_credit'] = '<span id="footer-thankyou">' . sprintf(esc_html__('Powered by  %1$s', 'redux-framework'), '<a href="' . esc_url($this->framework_url) . '" target="_blank">' . esc_html__('Redux Framework', 'redux-framework') . '</a> v' . ReduxCore::$_version) . '</span>';
            }
