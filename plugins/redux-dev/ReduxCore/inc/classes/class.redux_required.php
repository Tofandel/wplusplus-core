					...
					if ( is_array( $parent_value ) ) {
						foreach ( $parent_value as $idx => $val ) {
							if ( is_array( $check_value ) ) {
								...
								if ( Redux_Helpers::makeBoolStr( $val ) === Redux_Helpers::makeBoolStr( $check_value ) ) {
									$return = true;
								}
							}
						}
						...
						if ( is_array( $check_value ) ) {
							foreach ( $check_value as $i => $v ) {
								if ( Redux_Helpers::makeBoolStr( $parent_value ) === Redux_Helpers::makeBoolStr( $v ) ) {
									$return = true;
								}
							}
						} else {
							if ( Redux_Helpers::makeBoolStr( $parent_value ) === Redux_Helpers::makeBoolStr( $check_value ) ) {
								$return = true;
							}
						}
					}
