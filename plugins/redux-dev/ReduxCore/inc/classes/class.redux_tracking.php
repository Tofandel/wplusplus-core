    ...
    class Redux_Tracking {
        ...
        public function load($parent) {
            ...
            if (isset($_GET['page']) && $_GET['page'] == $this->parent->args['page_slug']) {
                ...
                } else if (empty($this->options['tour']) && ( $this->parent->args['dev_mode'] == "true" || $this->parent->args['page_slug'] == "redux_demo" )) {
        ...
        function print_scripts($selector, $options, $button1, $button2 = false, $button2_function = '', $button1_function = '') {
            ...
            <?php if ($button2) { ?>
                            ptc.after('<a id="pointer-primary" class="button-primary">' + '<?php echo esc_html($button2); ?>' + '</a>');
