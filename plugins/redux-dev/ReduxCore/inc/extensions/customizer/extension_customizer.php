...
if (!class_exists('ReduxFramework_extension_customizer', false)) {
    ...
    class ReduxFramework_extension_customizer {
        ...
        function enqueue_controls_css() {
            ...
            wp_enqueue_script(
                    'redux-extension-customizer-js', $this->_extension_url . 'extension_customizer' . Redux_Functions::isMin() . '.js', array('jquery', 'redux-js'), ReduxFramework_extension_customizer::$version, true
            );
        ...
        public function _enqueue_previewer() {
            wp_enqueue_script(
                    'redux-extension-previewer-js', $this->_extension_url . 'assets/js/preview.js'
            );
            ...
            wp_localize_script(
                    'redux-extension-previewer-js', 'reduxPost', $localize
            );
        }
