...
if (!class_exists('ReduxFramework_options_object', false)) {
    ...
    class ReduxFramework_options_object extends Redux_Field {
            ...
            if (!$this->is_field || ( $this->is_field && false == $fullWidth )) {
                ...
                <table id="<?php echo esc_attr($id); ?>" class="form-table no-border redux-group-table redux-raw-table" style=" overflow: <?php esc_attr($this->field['overflow']); ?>;">
                    <tbody><tr><td>
                            ...
                            ?>
                            <fieldset id="<?php echo esc_attr($id); ?>-fieldset"
                                ...
                                <a href="#" id="consolePrintObject"
                                   class="button"><?php esc_html_e('Show Object in Javascript Console Object', 'redux-framework'); ?></a>
                                </div>
                            </fieldset>
                            <?php if (true == $bDoClose) { ?>
                            </td></tr></table>
        ...
        public function enqueue() {
            wp_enqueue_script(
                    'redux-options-object', $this->_url . 'field_options_object' . Redux_Functions::isMin() . '.js', array('jquery', 'redux-js'), ReduxFramework_extension_options_object::$version, true
            );

            wp_enqueue_style(
                    'redux-options-object', $this->_url . 'field_options_object.css', array(), ReduxFramework_extension_options_object::$version, 'all'
            );
        }
