...
if ( ! class_exists( 'Redux_Welcome', false) ) {
	class Redux_Welcome {
		...
		public function check_version() {
			...
			$curVer  = Redux_Helpers::major_version( ReduxCore::$_version );
			$compare = false;
		...
		public function admin_head() {
			...
			//$badge_url = ReduxCore::$_url . 'assets/images/redux-badge.png';
			?>
			...
			<script
					...
					src='<?php echo esc_url( ReduxCore::$_url ) ?>inc/welcome/js/redux-welcome-admin.js'>
			</script>
			...
			<link rel='stylesheet' id='redux-welcome-css'
				  href='<?php echo esc_url( ReduxCore::$_url ); ?>inc/welcome/css/redux-welcome.css'
				  type='text/css' media='all'/>
			<style type="text/css">
				.redux-badge:before {
