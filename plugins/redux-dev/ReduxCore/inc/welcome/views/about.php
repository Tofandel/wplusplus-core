<div class="wrap about-wrap">
	...
	<div
			class="redux-badge"><i
				class="el el-redux"></i><span><?php printf( esc_html__( 'Version', 'redux-framework' ) . ' %s', ReduxCore::$_version ); ?></span>
	</div>
				...
				<div>
					...
					<p>This version the fastest Redux ever released. We've integrated ajax_saving as well as many other
						speed improvements to make Redux even surpass the load time of <a
								href="<?php echo 'https://'; ?>github.com/syamilmj/Options-Framework" target="_blank">SMOF</a>
						even with
						large panels.</p>
				</div>
				<div>
