...
<div class="wrap about-wrap">
    ...
    <div class="about-text">
        <?php esc_html__('Supercharge your', 'redux-framework') . ' Redux ' . esc_html__('experience. Our extensions provide you with features that will take your products to the next level.', 'redux-framework'); ?>
    </div>
