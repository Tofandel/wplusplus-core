...
?>
<div class="wrap about-wrap" style="max-width:initial;margin:10px 20px 0 2px;" xmlns="http://www.w3.org/1999/html">
		...
		<form id="supportform">
			...
			<fieldset id="final_support">
				...
				<div class="is_developer">
					...
					<a href="<?php echo esc_url( 'https://github.com/reduxframework/redux-framework/issues' ) ?>"
					   target="_blank">
