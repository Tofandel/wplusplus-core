...
// Don't duplicate me!
if ( ! class_exists( 'ReduxFramework_extension_css_layout', false ) ) {
	 ...
	 * @since       1.0.0
	 */
	class ReduxFramework_extension_css_layout {
		...
		public function __construct( $parent ) {
			...
			// Set field name
			$this->field_name = 'css_layout';

			// Set instance
			self::$theInstance = $this;

			include_once( $this->extension_dir . 'css_layout/inc/class.css_layout_functions.php' );
