...
// Don't duplicate me!
if ( ! class_exists( 'ReduxFramework_extension_spectrum', false ) ) {


	/**
	 * Main ReduxFramework spectrum extension class
	 *
	 * @since       1.0.0
	 */
	class ReduxFramework_extension_spectrum {
		...
		public function __construct( $parent ) {
			...
			// Set field name
			$this->field_name = 'spectrum';

			// Set instance
			self::$theInstance = $this;

			// Uncomment when customizer works - kp
			//include_once($this->extension_dir . 'spectrum/inc/class.customizer.php');
